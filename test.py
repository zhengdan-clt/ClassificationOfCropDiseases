...
data_path = "../wheat-leaf-disease_split"  # todo 修改为数据集根目录
model_path = "E:/项目/checkpoints/resnet50d_nopretrained_224/resnet50d_9epochs_accuracy0.87536_weights.pth"  # todo 模型地址
