...
model_path = "E:/项目/checkpoints/resnet50d_nopretrained_224/resnet50d_9epochs_accuracy0.87536_weights.pth"  # todo  模型路径
classes_names = ['Brown rust', 'Healthy', 'Septoria', 'Yellow rust']  # todo 类名
...
if __name__ == '__main__':
    ...
    #               save_dir="D:/xxxx")
    # 单张图片预测函数
    predict_single(model_path=model_path, image_path="images/test_imgs/3FAKM2.jpg")
